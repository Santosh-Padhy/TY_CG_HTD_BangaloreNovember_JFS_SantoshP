...
public class ContractDaoImpl implements ContractDao {
	...
	public List<Contract> getContract(int contractno) {
		...
		try {
			...
			while(resultSet.next()) {
				...
				contract.setCustomerid(resultSet.getLong("customerid"));
				contract.setProductid(resultSet.getLong("productid"));
				contract.setHaulierid(resultSet.getLong("haulierid"));
				contract.setDeliverydate(resultSet.getDate("deliverydate"));
	...
	public boolean modifyContract(Contract contract) {
		...
		String updatequery = "Update contract_info SET customerid=?,productid=?,haulierid=?,deliverydate=?,deliveryday=?,quantity=? WHERE contrctno=?";
		try {
